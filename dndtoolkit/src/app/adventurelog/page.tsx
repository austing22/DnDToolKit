...
export default function AdventureLogPage() {
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    console.log({ type, entry }); // Replace with API POST call
  };
